...
const JANET_FIELD_METADATA = {
  ...
  allergyMaterialSelections: {
    ...
    prompt: {
      en: "Do you have any material or contact allergies, like latex or adhesive? You can say the allergy name, say none, or say I don't know.",
      es: '¿Tienes alguna alergia a materiales o de contacto, como látex o adhesivos? Puedes decir el nombre de la alergia, decir ninguna, o decir no lo sé.',
    },
  ...
  allergyFoodSelections: {
    ...
    prompt: {
      en: "Do you have any food allergies, like peanuts or shellfish? You can say the allergy name, say none, or say I don't know.",
      es: '¿Tienes alguna alergia alimentaria, como cacahuates o mariscos? Puedes decir el nombre de la alergia, decir ninguna, o decir no lo sé.',
    },
  ...
  allergyEnvironmentalSelections: {
    ...
    prompt: {
      en: "Do you have any environmental allergies, like pollen or dust? You can say the allergy name, say none, or say I don't know.",
      es: '¿Tienes alguna alergia ambiental, como polen o polvo? Puedes decir el nombre de la alergia, decir ninguna, o decir no lo sé.',
    },
  ...
  medications: {
    ...
    label: 'medications',
    prompt: {
      en: 'What medications are you taking right now, like albuterol or ibuprofen? You can say none.',
  ...
  immunizationTravelSelections: {
    ...
    prompt: {
      en: 'Which travel or risk-based vaccines should we note, like yellow fever or hepatitis? You can say none or unsure.',
  ...
  chiefConcern: {
    ...
    prompt: {
      en: 'What is the reason for your visit today, like cough, fever, or sore throat?',
      es: '¿Cuál es el motivo de tu visita hoy, como tos, fiebre o dolor de garganta?',
    },
  ...
  symptomDuration: {
    ...
    prompt: {
      en: 'How long has this been going on, like since today, three days, or two weeks?',
      es: '¿Cuánto tiempo ha estado pasando esto, como desde hoy, tres días o dos semanas?',
    },
    title: 'Duration',
  },
  painLevel: {
    ...
    label: 'severity',
    prompt: {
      en: 'How severe is it right now, like mild, moderate, severe, or a number from one to ten?',
      es: '¿Qué tan severo es ahora mismo, como leve, moderado, severo, o un número del uno al diez?',
    },
    title: 'Severity',
  },
  symptomNotes: {
    ...
    label: 'symptom notes',
    prompt: {
      en: 'Anything else you want staff to know about your symptoms, like worse at night or after eating? You can say no.',
      es: '¿Hay algo más que quieras que el personal sepa sobre tus síntomas, como peor por la noche o después de comer? Puedes decir no.',
    },
    title: 'Symptom Notes',
  },
  pastMedicalHistoryChronicConditions: {
